---
title: "ShinyButchR"
author: "Andres Quintero, Daniel Hübschmann, Nils Kurzawa, Sebastian Steinhauser, Philipp Rentzsch, Stephen Krämer, Carolin Andresen, Jeongbin Park, Roland Eils, Matthias Schlesner and Carl Herrmann "
date: "27.07.2020"
vignette: >
  %\VignetteIndexEntry{ShinyButchR}
...
![ShinyButchR running NMF](ShinyButchR_figs/ShinyButchR_005.png)
...
![H matrix heatmap](ShinyButchR_figs/ShinyButchR_006.1.png)
...
![H matrix heatmap - annotation](ShinyButchR_figs/ShinyButchR_007.png)
...
![H matrix heatmap and UMAP - select K](ShinyButchR_figs/ShinyButchR_008.png)
...
In ShinyButchR a revery plot os made for all the associated categorical 
variables available in the annotaiton table. (**Figure 9.1**).


## Determining the optimal factorzation rank

Based on the results of the factorization quality metrics, the optimal number 
of signatures (k) is determined by minizing the Frobenius error, the coefficient 
...
![Recovery plots and optimal factorization rank](ShinyButchR_figs/ShinyButchR_009.png)
...
![riverplot](ShinyButchR_figs/ShinyButchR_010.png)
...
**ButchR_NMF** compatible with the latest version of ButchR. To use this object 
you can start a new R session and read read it like this:
...
selected factorization rank.

![Download results](ShinyButchR_figs/ShinyButchR_011.png)
